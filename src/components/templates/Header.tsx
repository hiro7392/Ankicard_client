                ...
                <nav className="bg-slate-700 w-screen">
                    <div className="flex justify-between">
                        ...
                        <div className="flex items-left">
                            <div className="flex items-left text-right text-gray-200 hover:bg-gray-300 hover:text-gray-700 my-auto rounded px-2 py-1 mr-2 border-solid border-blue-100">
