    ...
    return(
        <>
            ...
            <form className="flex flex-col w-1/2 mt-8 mx-auto bg-slate-300 rounded-lg" onSubmit={handleSubmit(onSubmit)}>
                <label className="h-56 mt-8 mx-10 bg-slate-100 rounded-lg">
                    <p className="text-left pl-3  py-2 text-slate-100 bg-slate-600"> 問題文</p>
                    <input type="text" className="h-48 w-full bg-slate-100 rounded-lg" 
                ...
                <input className="bg-teal-400 py-2 w-48 mb-4 mt-10 mx-auto text-4xl rounded-lg text-white hover:bg-teal-300" type="submit"/>
                {/*
